        ...
        path_authorization_rules.update(
            {
                ...
                (f"{prefix}/bindings", "GET"): _mcp_servers_rule(
                    "list",
                ...
                (f"{prefix}/<path:name>/versions/<path:version>/tags/<path:key>", "DELETE"): _mcp_servers_rule(
                    "delete",
                    resource_name_parsers=mcp_server_name_parsers,
                ),
                (f"{prefix}/<path:name>/bindings", "POST"): _mcp_servers_rule(
                    "create",
                    resource_name_parsers=mcp_server_name_parsers,
                ),
                (f"{prefix}/<path:name>/bindings", "GET"): _mcp_servers_rule(
                    "list",
                    resource_name_parsers=mcp_server_name_parsers,
                ),
                (f"{prefix}/<path:name>/bindings/<binding_id>", "GET"): _mcp_servers_rule(
                    "get",
                    resource_name_parsers=mcp_server_name_parsers,
                ),
                (f"{prefix}/<path:name>/bindings/<binding_id>", "PATCH"): _mcp_servers_rule(
                    "update",
                    resource_name_parsers=mcp_server_name_parsers,
                ),
                (f"{prefix}/<path:name>/bindings/<binding_id>", "DELETE"): _mcp_servers_rule(
                    "delete",
                    resource_name_parsers=mcp_server_name_parsers,
                ),
